...
The Astro routes and shared styles, catalog snapshot importer and data, Google Sheet metadata columns, and README will change. The public site remains static and does not request Google Sheets at runtime. Cover images come from Cover Art Archive URLs, with attribution and a no-art fallback.
